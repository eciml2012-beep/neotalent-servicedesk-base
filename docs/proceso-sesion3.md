...
- **Diseño con KirriDesk:** se toma la estructura (navegación a la izquierda, paneles, sugerencia de la IA en su bloque con «Aceptar», «Corregir» y «Deshacer» fuera). La paleta y la tipografía de la Fase 2 no cambian: fondo hueso `#F4F3EF`, paneles `#FDFCFA` e IBM Plex. Sin avatares ni caras, por el principio 3. Detalle en `docs/diseno.md`.
- **Hallazgo del QA para debatir:** la fuente IBM Plex cargada desde Google choca con el principio 6 (sin dependencias externas).

## Pendiente de validar en grupo

Las preguntas 4, 5 y 6 del spec se cerraron con la opción recomendada:

- Los tickets que no encajan van a «Sin clasificar».
- Los tickets cerrados también llevan sugerencia.
